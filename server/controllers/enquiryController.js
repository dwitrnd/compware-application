...
class enquiryController {
  ...
  static patchState = async (req, res) => {
    try {
      const { email, status, courseName, courseLink, name } = req.body;
