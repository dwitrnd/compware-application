        ...
        <section id='hero-banner'>
          <div id='video-box'>
            <video autoPlay muted loop controlsList='nodownload' style={{ filter: "brightness(0.5)" }}>
              <source src={"https://video.deerwalktrainingcenter.com/"} type='video/mp4' />
            </video>
          </div>
          ...
          <div id='hero-content'>
            ...
            <HeroSubTitle id='hero-subtitle' style={{ marginTop: "4rem", marginBottom: "4rem" }}>
              Welcome to Deerwalk Training Center, where we are dedicated to providing premiere IT and Technical skills to facilitate your journey towards achieving success.
            </HeroSubTitle>
