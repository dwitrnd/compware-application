...
const UpdateCourse = () => {
  ...
  const categoryUrl = "http://localhost:5001/api/courseCategory"; // category URL
  ...
  useEffect(() => {
    ...
    axios.get(apiUrl).then((res) => {
      ...
      setCourseCategory(courseCategory); // Set the course category
  ...
  const handleCategoryChange = (e) => {
    ...
    setCourseCategory(selectedCategories);
  };
          ...
          >
            {categories.map((data, index) => (
              <option
                ...
                selected={courseCategory.includes(data.categories)}
              >
                {data.categories}
              </option>
            ))}
