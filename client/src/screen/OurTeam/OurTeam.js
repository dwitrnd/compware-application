...
export default function OurTeam(props) {
  ...
  const content = {
    ...
    "03_image": "https://deerwalkcompware.com/training/uploads/team/Yaghya%20Lamsal.png",
    "03_name": "Ian Brown",
        ...
        <Box pt={5} pb={10} textAlign='center'>
          <Box mb={9}>
            <Container maxWidth='sm'>
              ...
              <Typography variant='h3' component='h2' gutterBottom={true}>
                <Typography variant='h3' component='span' className='gradient-text'>
                  {content["header-p1"]}{" "}
                </Typography>
          ...
          <Grid container spacing={6}>
            <Grid item xs={12} sm={6} md={3}>
              ...
              <Typography className='blue-color' variant='h6' component='h6' gutterBottom={true}>
                {content["01_name"]}
              </Typography>
