  ...
  return (
    <>
      <Stack direction='column' spacing={4}>
        <Stack direction={{ sm: "column", md: "row" }} sx={{ marginTop: "2rem" }} spacing={2}>
          ...
          <Stack direction='column' spacing={4}>
            ...
            <span>
              {" "}
              <Typography variant='subtitle2'>By:- {author}</Typography> <Typography variant='subtitle 2'>Date: {date}</Typography>{" "}
            </span>
            ...
            <Link to={`/blog-page/${id}`}>
              <Button variant='outlined' style={{ display: "flex", justifyContent: "flex-end" }}>
                Read More
              </Button>
            </Link>
          </Stack>
