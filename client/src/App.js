...
import ListCourseCategory from "screen/Dashboard/ListCourseCategory/ListCourseCategory";
import CreateCourseCategory from "screen/Dashboard/ListCourseCategory/CreateCourseCategory";
import EditCourseCategory from "screen/Dashboard/ListCourseCategory/EditCourseCategory";
        ...
        <ThemeProvider theme={theme}>
          <BrowserRouter>
            <Routes>
              ...
              />
              <Route
                path="/dashboard/create-course-category"
                element={
                  <DashboardLayout>
              ...
              />
              <Route
                path="/dashboard/list-course-category"
                element={
                  <DashboardLayout>
                    <ListCourseCategory />
                  </DashboardLayout>
              ...
              />
              <Route
                path="/dashboard/update-course-category/:id"
                element={
                  <DashboardLayout>
                    <EditCourseCategory/>
                  </DashboardLayout>
